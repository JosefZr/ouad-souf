...
export default function Footer() {
    return (
        <footer className="bg-my-to ">
            <div className="mx-auto px-4 pt-16 pb-6 sm:px-6 lg:pt-24 ">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">0560016000</span>
                                    </a>
                                </li>
                                ...
                                >
                                    ...
                                    <address className="-mt-0.5 flex-1 text-gray-700 not-italic">
                                        Zone activité kiuinine .BP 11 El oued 39014 Algeria
                                    </address>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; {new Date().getFullYear()} SARL Bennour industrie et services</p>
                    </div>
                </div>
            </div>
        </footer>
