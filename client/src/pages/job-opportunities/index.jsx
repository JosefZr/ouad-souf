...
export default function JobOpportunities() {
    ...
    return (
        <div
        className={`min-h-screen bg-[#01020b] text-white transition-transform duration-300 ${
                ...
                <div className="sticky z-10 bg-my-dark-blue">
                    ...
                    <section className=" flex flex-col sm:flex-row h-auto font-medium w-full gap-4 max-sm:gap-1 px-3 max-sm:px-0 my-3">
                        {menuItems.map((menuItem, index) => (
                            ...
                            >
                                <div className={`  mt-0 block py-[17px] px-[69px] max-md:px-0 max-md:py-[10px] w-full rounded-[100px] border-t-[2px] border-x-[1px] border-b-[1px] border-white  ${
